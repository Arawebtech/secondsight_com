            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto" style="display: flex; align-items: center; flex-wrap: wrap;">
                    <li class="nav-item" id="mobile-notfi" style="list-style-type:none;">
                        ...
                        <a href="#" class="nav-link" id="notificationBell" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <i class="fas fa-bell"></i>
                            <span id="notificationCount"
                                class="badge badge-danger"><?php echo $notification_count; ?></span>
                        </a>

                        <div class="dropdown-menu" aria-labelledby="notificationBell"
                            style="min-width: 250px; position: absolute; right: 0;">
                            <h6 class="dropdown-header">Notifications</h6>
                            <?php if (count($notifications) > 0): ?>
                                <?php foreach ($notifications as $notification): ?>
                                    <a class="dropdown-item" href="#explore-courses-section" data-toggle="tab"
                                        style="padding: 10px; border-bottom: 1px solid #f1f1f1; display: flex; flex-direction: column;white-space: pre-wrap;background-color: transparent !important;">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="order-section">
                    <?php if (!empty($orders)): ?>
                        ...
                        <?php foreach ($orders as $order): ?>
                            <h5>Courses for Order ID: <?php echo htmlspecialchars($order['order_id']); ?></h5>
                            <table class="table table-bordered">
                                <thead>
                                    <tr class="font-css-th">
                                        <th>Course Name</th>
                                    ...
                                    <?php if (isset($courses_by_order[$order['order_id']])): ?>
                                        <?php foreach ($courses_by_order[$order['order_id']] as $course): ?>
                                            <tr class="font-css-td">
                                                ...
                                                <td>Rs.<?php echo htmlspecialchars(number_format($course['price'], 2)); ?></td>
                                                <td>Rs.<?php echo htmlspecialchars(number_format($course['subtotal'], 2)); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                ...
                <div class="tab-pane fade" id="batchcode">
                    ...
                    <form id="batchcodeForm">
                        <input type="text" placeholder="Enter batch code to access courses" name="enterbatchcode"
                            id="enterbatchcode" class="form-control w-25 mb-3" required>
                        <button type="submit" name="submit-code" class="btn btn-success">Access</button>
                    </form>
                    <div class="mt-3">
                                        ...
                                        <div class="content-box col-lg-8 col-md-6 col-12 row">
                                            ...
                                            <div style="padding-top:-20px; margin-top: 20px;">
                                                <a class="btn btn-primary float-end"
                                                    href="<?= $base_url . 'lessons.php?course_id=' . $course['id'] ?>"
                                                    style="font-size:1rem;">Access Course</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- Explore Courses Section - unchanged -->
                <div class="tab-pane fade" id="explore-courses-section">
                    ...
                    <section class="courses-area-style ptb-60">
                        <div class="container">
                            <div class="row" id="courseResultsContainer">
                                <?php
                                // Initial course load
                    ...
                    <form id="updateProfileForm" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="mobile"
                                value="<?php echo htmlspecialchars($user['mobile']); ?>" pattern="[0-9]{10}"
                ...
                <div class="modal-body pt-0">
                    <form id="changePasswordForm" method="POST" action="">
                        <div class="form-group mb-3">
                            ...
                            <input type="password" class="form-control custom-input" id="old_password"
                                name="old_password" required placeholder="Enter old password">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="password" class="form-control custom-input" id="confirm_new_password"
