...
if (isset($_POST['submit']) and $_POST['submit'] == 'Save') {
	$b_name = addslashes($_POST['t_name']);
	$b_title = addslashes($_POST['t_title']);
	...
	$meta_description = addslashes($_POST['meta_description']);
	 ...
	 $youtube_video_url = addslashes($_POST['youtube_video_url']);
...
// 	}
	...
	$sql_query = "INSERT INTO testimonials (t_name, t_title, short_name, description, banner_image,  alt, meta_keyword, meta_description, b_schema, status, created_date, created_by, updated_date, youtube_video_url) VALUES ('$b_name', '$b_title', '$short_name', '$description', '$banner_image', '$alt', '$meta_keyword', '$meta_description', '$b_schema', '$status', '$created_date', '', '', '$youtube_video_url')";

	$res_query = mysqli_query($conn, $sql_query);

	if ($res_query > 0) {
		exit("<script>window.location.href='view-testimonial.php?id=Added';</script>");
	} else {
...
// 		$banner_image = $_POST['banner_image2'];
	...
	$sql = "UPDATE testimonials SET t_name = '$b_name', t_title = '$b_title',  short_name = '$short_name', description = '$description', banner_image = '$banner_image',  alt = '$alt', meta_keyword = '$meta_keyword', meta_description = '$meta_description', b_schema = '$blog_schema', status = '$status', youtube_video_url = '$youtube_video_url'  WHERE id = '$id'";

	$resq = mysqli_query($conn, $sql);

	if ($resq) {
		exit("<script>window.location.href='view-testimonial.php?id=Update';</script>");
	} else {
...
if (isset($_GET['id'])) {
	...
	$query = "SELECT * FROM testimonials WHERE id ='$blog_id'";
...
<body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <div class="box-body">
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><?php if (isset($_GET['id'])) echo 'Update testimonial';
																else echo 'Add Testimonial';  ?></h3>
                                    </div>
                                    <div class="box-body">
                                        <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="t_name" type='text' name='t_name'
                                                                value="<?php echo $info_blog->t_name; ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type='text' id="t_title" name='t_title'
                                                                value="<?php echo $info_blog->t_title; ?>"
                                                                class='form-control reporttitle' required>
                                                        </div>
                                                        <span class="errorMSG" id="msgNAME"></span>
                                                    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="youtube_video_url" value="<?php echo $info_blog->youtube_video_url; ?>" class="form-control">
    </div>
</div>
