                    ...
                    while ($info_item = mysqli_fetch_object($result_item)) {  ?>
                                        <tr style="color:<?php if (!empty($color)) {
                                          echo $color;
                                            ...
                                            <td><?php echo $info_item->b_name; ?></td>
                                            <td><?php echo $info_item->b_title; ?></td>
                                            <td><img src="../assets/img/single-blog/<?php echo $info_item->banner_image; ?>"
                                                    width="100px"></td>
                                                    
                                            <td> <a href="toggle_status.php?toggleblog=<?php echo $info_item->id; ?>">
                                            ...
                                            <td width="10%">
                                               <a href="../blog/<?php echo $info_item->url ?>" target="_blank">
                                                        <i class="fa-regular fa-eye" style="font-size:16px;" title="view"></i>
                                                    </a>
                                            <a href="add-blog.php?id=<?php echo $info_item->id; ?>"><i class="fa fa-edit" style="font-size:18px;" title="Edit"></i></a>
                                                <a href="view-blog.php?del=<?php echo $info_item->id ?>"
