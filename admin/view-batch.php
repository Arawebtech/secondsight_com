                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $query = "SELECT b.*, 
        (SELECT COUNT(*) FROM lesson_video lv WHERE lv.batch_id = b.id) as lesson_count,
        COUNT(DISTINCT ube.user_id) as enrolled_students
FROM batch b 
LEFT JOIN user_batch_enrollments ube 
ON b.id = ube.batch_id AND ube.status='Active'
GROUP BY b.id
ORDER BY b.id DESC";
