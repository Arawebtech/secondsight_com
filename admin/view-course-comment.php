...
if (isset($_GET['del'])) {
  $id = $_GET['del'];
  $query  = "DELETE FROM course_comment WHERE id ='$id' ";
...
<head>
    ...
    <title>Admin- Course Comment</title>
        ...
        <div class="content-wrapper" style="margin-top:35px;padding-left:30px;">
            <section class="content-header">
              ...
              if (isset($_GET['id']) && $_GET['id'] == 'Added') {
                echo '<p style="color:green;">Your Reply successfully</p>';
              }
                    ...
                    while ($info_item = mysqli_fetch_object($result_item)) {  ?>
                                        <tr style="color:<?php if (!empty($color)) {
                                          echo $color;
                                            ...
                                            <td><?php echo $info_item->comment; ?></td>
                                            <td><?php echo $info_item->course_name; ?></td>
                                            ...
                                            <td width="10%">
                                               ...
                                               <a href="add-reply.php?id=<?php echo $info_item->id ?>"><i
                                                        class="fa fa-edit" style="font-size:24px;"
                                                        title="Reply"></i></a>
                                                <a href="view-course-comment.php?del=<?php echo $info_item->id ?>"
