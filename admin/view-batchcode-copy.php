                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT bc.*, 
                                                            b.batch_title,
                                                            b.month_year,
                                                            COUNT(DISTINCT lb.lesson_id) as lesson_count
                                                     FROM batchcode bc
                                                     JOIN batch b ON bc.batch_id = b.id
                                                     LEFT JOIN lesson_batch lb ON b.id = lb.batch_id
                                                     GROUP BY bc.id, bc.batchcode_name, bc.max_usage, bc.current_usage, 
                                                              bc.expiry_date, bc.status, bc.created_date, b.batch_title, b.month_year
                                                     ORDER BY bc.id DESC";
