(function ($) {
    ...
    $(".partner-wrap").owlCarousel({
        ...
        responsive: { 0: { items: 2 }, 576: { items: 3 }, 768: { items: 4 }, 992: { items: 6 }, 1200: { items: 6 } },
    });
    $(".feedback-slider").owlCarousel({ loop: true, margin: 30, nav: false, items: 1, dots: true, autoplay: true, smartSpeed: 1000, autoplayHoverPause: true });
    ...
    bigimage
        .owlCarousel({ items: 1, slideSpeed: 2000, nav: true, autoplay: true, dots: false, loop: true, responsiveRefreshRate: 200, navText: ["<i class='bx bx-left-arrow-alt'></i>", "<i class='bx bx-right-arrow-alt'></i>"] })
